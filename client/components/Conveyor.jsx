...
class Conveyor extends Component{
    ...
    render(){
        ...
        return(
            ...
            <div className={pagesStyle} id='conveyor' onTouchStart={this.onTouchStart} onTouchMove={this.onTouchMove} onTouchEnd={this.onTouchEnd}>
       
        
    <div className='page' id='home'>Home</div>
    <div className='page' id='about'>About</div>
    <div className='page' id='films'>Films</div>
    <div className='page' id='tv'>TV</div>
    <div className='page' id='music'>Music</div>
    <div className='page' id='arvr'>AR/VR</div> 
...
export default withRouter(Conveyor);
